<template>
  ...
  <div class="detailFooter">
    <div class="footerTop">
      ...
      <svg class="icon liebiao" aria-hidden="true" @click="$router.push('/comments')">
    ...
    watch: {
        currentTime: function (newValue) {
            ...
            if (newValue === this.duration) {
                if (this.playListIndex === this.playList - 1) {
